             ...
             <div className="row location-information">
                 ...
                 <div className="py-1">
                   ...
                   <div className='d-flex justify-content-between extra-body'>
                    <Button size="large"  variant="contained" > <ChevronLeftIcon></ChevronLeftIcon></Button>
                    <Button size="large"  variant="contained"> <ChevronRightIcon></ChevronRightIcon></Button>
                   </div>
             </div> 
        </div>
    );
