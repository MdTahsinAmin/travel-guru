...
const Header = () => {
    ...
    return (
        ...
        <Link to='/contact'>Contact</Link>
            ...
            {
                loginUser.success && <button style={{marginLeft:'12px'}}  className ="login-btn">Logout</button>!loginUser.success && <button onClick={handleHistory} className ="login-btn">Login</button>
            }
        </Nav>
    </Navbar.Collapse>
    </Navbar>
